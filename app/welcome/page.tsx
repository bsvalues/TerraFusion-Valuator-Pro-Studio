        ...
        <section className="py-14">
          ...
          <div className="mt-8 rounded-2xl border border-border p-6">
            ...
            <ol className="mt-3 space-y-2 text-sm text-foreground">
              <li><span className="font-semibold text-cyan-400">1.</span> Open the workbench.</li>
              <li><span className="font-semibold text-cyan-400">2.</span> Set your subject + assignment conditions.</li>
              <li><span className="font-semibold text-cyan-400">3.</span> Run the three approaches, reconcile, draft the narrative.</li>
              <li><span className="font-semibold text-cyan-400">4.</span> Export your PDF.</li>
            </ol>
            <Link href="/workbench" className="mt-6 inline-flex items-center justify-center rounded-lg bg-cyan-500 px-5 py-3 text-sm font-semibold text-background hover:bg-cyan-400">Open the workbench →</Link>
          </div>
